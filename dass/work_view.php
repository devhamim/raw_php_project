...
<head>
        ...
        <title>H - Personal Portfolio HTML5 Template</title>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <a href="index.php" class="navbar-brand s-logo-none"><img width="80" src="/web_div/dass/uplode/logo/<?=$after_assoc_logo['logo']?>"></a>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="uplode/work/<?=$after_assoc['image']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?=$after_assoc['title']?></h2>
                                    <p><?=$after_assoc['dess']?></p>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img width="100" src="/web_div/dass/uplode/user/<?=$_SESSION['photo']?>" alt="img">
                                            </div>
